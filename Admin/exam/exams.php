...
<section id="main-content">
    <section class="wrapper">
      ...
      if(($date>=8) && ($date<=1))
      {
          ?>
                    ...
                    <div class="row" style="padding-top:90px;">
                       ...
                       <a href="exam.php?sem=3rd"> <div class="market-updates">
            <div class=" col-md-offset-2 col-md-8 market-update-gd">
                <div class="market-update-block clr-block-2">
                    <div class="col-md-4 market-update-right">
                     ...
                     <h4>Third<br/>Semester</h4>
                    
                  </div>
                  <div class="clearfix"> </div>
                </div><br/>
            </div></a>
                             <a href="exam.php?sem=5th"> <div class="market-updates">
            <div class=" col-md-offset-2 col-md-8 market-update-gd">
                <div class="market-update-block clr-block-2">
                    <div class="col-md-4 market-update-right">
                        <i class="fa "> </i>
                     ...
                     <div class="col-md-8 market-update-left">
                     <h4>Fifth<br/>Semester</h4>
                
                  </div>
                  <div class="clearfix"> </div>
                </div><br/>
            </div></a>
                            <a href="exam.php?sem=7th"> <div class="market-updates">
            <div class=" col-md-offset-2 col-md-8 market-update-gd">
                <div class="market-update-block clr-block-2">
                    <div class="col-md-4 market-update-right">
                        <i class="fa "> </i>
      ...
      else
      {
          ?>
                        <div class="row" style="padding-top:90px;" >
                                 <a href="exam.php?sem=4th"> <div class="market-updates">
            <div class=" col-md-offset-2 col-md-8 market-update-gd">
                <div class="market-update-block clr-block-2">
                    <div class="col-md-4 market-update-right">
                        <i class="fa "> </i>
                  ...
                  <div class="clearfix"> </div>
                                    ...
                                    <a href="exam.php?sem=6th"> <div class="market-updates">
            <div class=" col-md-offset-2 col-md-8 market-update-gd">
                <div class="market-update-block clr-block-2">
                    <div class="col-md-4 market-update-right">
                        <i class="fa "> </i>

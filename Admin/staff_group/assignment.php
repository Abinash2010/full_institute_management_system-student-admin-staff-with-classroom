...
echo '<td>'.$result['Title'].'</td>
        ...
        <td>'.'<a href="../upload_assets/assignment_files/'.$result['File'].'" Download>'.'Download File'.'</a>'.'</td>
        <td>'.$result['date'].'</td>
        <td>'.$result['Due_date'].'</td>
        <td><a href="answer.php?a_id='.$result['Assignment_id'].'&gp_id='.$get.'" class="btn btn-primary">'.'View Submitted Coppies'.'</a>'.'</td></tr>';
      }
      ?>
      </tbody>
    </thead>

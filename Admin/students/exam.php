...
$type=$_GET['type'];
      ...
      $qsl1=$db->query("SELECT * FROM `subject` where `Class_code`='$sem'");
      $qsl1->execute();
    ...
    <section class="wrapper">
        <div class="row" style="padding-top:90px;" >
           ...
           <?php   foreach($data1 as $rows1)
                               {
                                   echo '<a href="viewmarks.php?sub='.$rows1['Subject_code'].'&type='.$type.'"> <div class=" col-md-offset-2 col-md-8 market-update-gd">
                <div class="market-update-block clr-block-2">
                    <div class="col-md-5 market-update-right">
                        <i class="fa "> </i>
                    </div>
                     <div class="col-md-7 market-update-left">
                     <h4>'.$rows1['Subject_code'].'</h4>

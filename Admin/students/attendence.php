...
$data1=$sql->fetchAll(PDO::FETCH_ASSOC);
 ...
 $stmt=$db->query("SELECT Class_code FROM `student` where `Student_id`='$temp'");
      $stmt->execute();
       $data=$stmt->fetch(PDO::FETCH_OBJ);
     
      $sqls=$db->query("SELECT * FROM `subject` where `Class_code`='$data->Class_code'");
          $sqls->execute();
          ...
          <div class="row" >
                ...
                <?php
                    foreach($result as $row)
                    {
                       ...
                       echo '<a href="viewattendence.php?attend='.$row['Subject_code'].'"> <div class="market-updates">
            <div class=" col-md-offset-1 col-md-4 market-update-gd">

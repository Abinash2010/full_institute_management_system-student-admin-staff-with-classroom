...
<section id="main-content">
    <section class="wrapper">
        <div style="float:left"><h2 >Placement</h2></div>
        <div style="float:right">   
          
          <a href="addprofile.php" ><img style="height:40px;width=40px;" src="../images/profile.png "/></a>
          </div>
          </div>
  <table class="table table-bordered">
      ...
      <tr>
       ...
       <?php
          ...
          $db=getDB();
          try{
            $sql = $db->prepare("SELECT * FROM `placement`join `company` on placement.Company_id=company.Company_id ");
            $sql->execute();
          ...
          echo '<tr><td>'.$row['Student_id'].'</td>
                    ...
                    <td>
                    <a href="deleteplacement.php?std_id='.$row['Student_id'].'" class="btn btn-danger" >'.'Delete'.'</a></td>

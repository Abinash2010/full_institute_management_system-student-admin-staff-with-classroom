    ...
    <section class="wrapper">
      <div>
        ...
        <div class="form-group">
               <?php echo '<form action="submit_module.php?a_id='.$aid.'&gp_id='.$get.'" method="post" enctype="multipart/form-data">'; ?>
               
                       
               <h4> <b>Answer:</b></h4>
                    <textarea class="form_text" style="margin-left:-10px;height:300px;width: 85%;" name="Ans"></textarea>
                <h4 > <b>File:</b></h4>
                    <input type="file" class="form_text" name="fil"/> 
                    
                <input type="submit" style={padding-top:-30px} class="btn btn-primary" name="submit" value="submit">
                <form>
            </div>

...
$stmt1=$db->prepare("SELECT * FROM staff ,staff_login where staff.role=0 and staff.Staff_id=staff_login.Staff_id ");
 ...
 <div id="container">
  <div class="sidebar">
	...
	<div class="content">
		...
		<h2 >Lab Instructors Of The Department
		</h2>
		</div>
    ...
    <?php  
     foreach( $result as $row )
           ...
           echo '<tr  ><td>'.$row['F_name'].' '.$row['M_name'].' '.$row['L_name'].'</td>
                    ...
                    <a href="editemployee.php?staff_id='.$row['Staff_id'].'" class="btn btn-primary" >'.'Edit'.'</a>
                    <a href="deleteemployee.php?staff_id='.$row['Staff_id'].'" class="btn btn-danger" >'.'Delete'.'</a></td>
